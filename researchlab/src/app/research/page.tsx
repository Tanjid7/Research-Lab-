          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${areaFilter === 'all' ? 'bg-lab-500 border-lab-500 text-white' : 'border-white/10 text-gray-400 hover:border-lab-500/50 hover:text-lab-300'}`}
              >
                All Areas
              </button>
              {LAB_CONFIG.researchAreas.map(a => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${areaFilter === a.id ? 'bg-lab-500 border-lab-500 text-white' : 'border-white/10 text-gray-400 hover:border-lab-500/50 hover:text-lab-300'}`}
                >
                  {a.label}
                </button>
              ))}
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${showFeatured ? 'bg-amber-500/20 border-amber-500/30 text-amber-400' : 'border-white/10 text-gray-400 hover:border-amber-500/50 hover:text-amber-300'}`}
            >
